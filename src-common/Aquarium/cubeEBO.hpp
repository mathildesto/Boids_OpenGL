...
struct CubeEBOProgram {
    ...
    CubeEBOProgram(Window3D& window) : m_Program(p6::load_shader("shaders/3D_light.vs.glsl", "shaders/normals.fs.glsl"))
    {
    ...
    void drawCube(GLuint cubeVAO, Camera::Freefly freefly, glm::mat4 normalMatrix, glm::mat4 projectionMatrix){
                ////////////////////////CUBE/////////////////////////////////////////
        auto modelViewMatrixCube  = glm::translate(freefly.getViewMatrix(), glm::vec3(0.f, 0.f, 0.f));
        m_Program.use();
